...
if (fixtureId) {
    ...
    document.getElementById('matchDetailsContainer').innerHTML = '<p>No match selected.</p>';
}
...
async function fetchMatchDetails(fixtureId) {
    ...
    try {
        ...
        if (data.response && data.response.length > 0) {
            ...
            document.getElementById('matchDetailsContainer').innerHTML = '<p>Match details not found.</p>';
        }
    } catch (error) {
        console.error('Error fetching match details:', error);
        document.getElementById('matchDetailsContainer').innerHTML = '<p>Error loading match details.</p>';
    }
}
...
function displayMatchDetails(match) {
  ...
  <div class="team-section">
    ...
    <div class="score-section">
      ...
      <span class="match-date">${new Date(match.fixture.date).toLocaleString()}</span>
    </div>
    <div class="team">
      <img
  ...
  <p class="venue"><strong>Venue:</strong> ${match.fixture.venue.name}, ${match.fixture.venue.city}</p>
